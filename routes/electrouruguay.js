...
router.get('/search', async (req, res) => {
    ...
    try {
        ...
        const searchUrl = `https://www.electrouruguay.com/catalogo?q=${encodeURIComponent(q)}`;
        ...
        $('input[type="hidden"]').each((index, el) => {
            ...
            // Buscamos los metadatos inyectados para el tracking de eCommerce
            if (val.includes('sku') && val.includes('fen')) {
                ...
                if (card.length > 0) {
                    ...
                    // Formato: $ 136,92 a U$S O $
                    // Nota: electrouruguay lista en Pesos. Los mostraremos tal cual en el catalog pero con su moneda.
        ...
        console.error('Error scraping ElectroUruguay:', error.message);
